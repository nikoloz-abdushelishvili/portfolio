...
Designing automated systems for practical use

Future Improvements

Add multiple sensors for watering several plants

Implement a logging system to track soil moisture over time
